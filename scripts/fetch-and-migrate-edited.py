...
def parse_args():
    args = argparse.ArgumentParser(description="Transfer ownership of tracked entities from one organisation unit to another")
...
def main():
    ...
    # enrollment_date = input("Enter date of enrollment (YYYY-MM-DD): ").strip()
    # formatted_enrollment_date = datetime.strftime("YYYY-MM-DD")
...
if __name__ == "__main__":
    ...
    URL = f"{dhis2_api_base}/42/tracker/trackedEntities?program=sXzdrtXMink"+"&orgUnit={}&totalPages=true&fields=*&skipPaging=true&enrollmentOccurredBefore=2025-03-15"
